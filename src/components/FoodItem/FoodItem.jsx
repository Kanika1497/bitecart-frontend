...
function FoodItem({ name, description, id, imageUrl, price }) {
  ...
  return (
    <div className="col-12 col-sm-5 col-md-4 col-lg-3 mb-4 d-flex justify-content-center">
      <div className="card" style={{ maxWidth: "320 px" }}>
        <Link to={`/food/${id}`}>
          <img
            src={imageUrl}
        ...
        <div className="card-footer d-flex justify-content-between bg-light">
          ...
          {quantities[id] > 0 ? (
            <div className="d-flex align-items-center gap-2">
              ...
              <button className="btn btn-success ctn-sm" onClick={()=>increaseQty(id)}>
